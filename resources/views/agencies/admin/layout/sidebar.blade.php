    ...
    <nav class="navbar bg-light navbar-light d-flex">
        <div class="d-flex align-items-center ms-4 mb-4">
            <div class="position-relative">
                <img class="rounded-circle" src="{{asset($user_data->profile ? 'images/agencies/logo/' . $user_data->profile : 'assets/images/logo.png') }}" alt="" style="width: 50px; height: 50px; object-fit: cover">

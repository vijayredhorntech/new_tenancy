              ...
              @foreach($agencies as $agence)
                  <tr>
                      ...
                      <div style="display: flex; gap: 5px">
                         <a href="{{ route('superadmin_staffupdate', $staff->id) }}"> <button class="btn btn-info" style="color: white; padding: 0px 10px; border-radius: 3px" title="Edit Agency"><i class="fa fa-pen" style="font-size: 12px"></i></button> </ad>

        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>HSADMIN</h3>
                </a>
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{ $user_data->profile_picture ? $user_data->profile_picture : 'img/user.jpg' }}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="button.html" class="dropdown-item">Fligh </a>
                            <a href="typography.html" class="dropdown-item">Visa</a>
                         </div>
                    </div>
                    <!-- <a href="widget.html" class="nav-item nav-link"><i class="fa fa-th me-2"></i></a> -->
                    <a href="{{route('agencies')}}" class="nav-item nav-link"><i class="bi bi-people"></i> Agency</a>
                    <a href="#" class="nav-item nav-link"><i class="bi bi-people"></i> Admin</a>
                    <a href="#" class="nav-item nav-link"><i class="bi bi-people"></i> Profile</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="">HIM soft</a>, All Right Reserved. This is  
                        </div>
